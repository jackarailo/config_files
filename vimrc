...
" You compelte me
" check https://stackoverflow.com/questions/47667119/ycm-error-the-ycmd-server-shut-down-restart-wit-the-instructions-in-the-docu
" to make it work if you have the ycmd error
...
set nofoldenable " stop automatic folding
